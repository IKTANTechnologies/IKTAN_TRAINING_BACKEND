...
class Constancia{
    ...
    async createPDF(template,orientation,carpeta,format){
        ...
        <div class=" contenedor-imagenes" >
          <div >
              <img class= " tamanio-logo " src=${this.curso.iktan.logoIzquierdo.url} alt="logo" >
          </div>
      
          <div>
              <img class=" tamanio-cuadro " src= "https://iktan-training-production.s3.amazonaws.com/Templates/Imagenes/Cuadro+gris+1.png?fbclid=IwAR1e4dP_XH86qXPOVrg3mspU798qs4uzauwvEzXaKf6tmuPrtlx274hRFEA" alt="cuadro" >
          </div>
          </div>
